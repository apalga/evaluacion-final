...
function validarAlumnosColegio(colegio) {
  let AlumnosCatedras = colegio.profesores.reduce((acum, valor) => {
    return acum + valor.catedras.reduce((acum2, valor2) => {
      return acum2 + valor2.alumnos;
    }, 0);
  }, 0);

  return colegio.cantidadAlumnos === AlumnosCatedras;
}

const resultado = validarAlumnosColegio(colegio);
